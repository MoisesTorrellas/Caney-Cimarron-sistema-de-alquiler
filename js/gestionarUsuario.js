...
let botonNav = document.querySelectorAll(".botonNav")[0];
...
if ($(titulo).text() == "Gestionar Usuario.") {
...
$(document).ready(function () {
	...
	$("#incluir").on("click", function () {
		...
		$("#titleModal").text("");
		$("#titleModal").append("Registrar Usuario<span>.</span>");
		abrirModal();
	});
...
function pone(pos, accion) {
	...
	if (accion == 0) {
		...
		$("#titleModal").text("");
		$("#titleModal").append("Modificar Usuario<span>.</span>");
	}
	else {
		$("#proceso").text("Eliminar Usuario");
		$("#titleModal").text("");
		$("#titleModal").append("Eliminar Usuario<span>.</span>");
	}
